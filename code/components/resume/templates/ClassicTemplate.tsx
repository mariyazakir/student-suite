 ...
 * Classic Template
 *
 * Traditional, ATS-friendly layout with serif typography.
 * Simple single-column formatting and clear section headings.
 */
      ...
      case 'summary':
        ...
        return (
          <section key={sectionKey} className="mb-5">
            <h2 className="text-base font-semibold uppercase tracking-wide text-gray-900 border-b border-gray-400 pb-1 mb-2">
              {title}
            </h2>
            <p className="text-gray-900 leading-relaxed text-sm">{data.personalInfo.summary}</p>
          </section>
        );
      case 'experience':
        ...
        return (
          <section key={sectionKey} className="mb-5">
            <h2 className="text-base font-semibold uppercase tracking-wide text-gray-900 border-b border-gray-400 pb-1 mb-3">
              {title}
            </h2>
