 ...
 * Executive Template
 *
 * Strong headers and clean dividers for leadership resumes.
 * ATS-friendly and single-column.
 */
...
export default function ExecutiveTemplate({
      ...
      case 'summary':
        ...
        return (
          <section key={sectionKey} className="mb-6">
            <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-gray-900 mb-2">
              {title}
            </h2>
  ...
  return (
    <div className="bg-white p-4 sm:p-6 md:p-8 max-w-4xl mx-auto font-sans w-full">
